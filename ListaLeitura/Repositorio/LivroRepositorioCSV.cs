...
namespace ListaLeitura.Repositorio
{
    ...
    {
        private static readonly string nomeArquivoCSV = "K:\\Projetos\\ListaLeitura\\ListaLeitura\\Repositorio\\livros.csv";

        private readonly ListaDeLeitura _paraLer;
        private readonly ListaDeLeitura _lendo;
        private readonly ListaDeLeitura _lidos;
